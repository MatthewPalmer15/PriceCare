...
class EditUserDetails(UserChangeForm):
	...
	first_name  = forms.CharField(
						max_length=32,
						required=False,
						widget=forms.TextInput(attrs={'class': 'form-control form-resize mx-auto my-2', 'placeholder': 'First Name'})
						)
	last_name 	= forms.CharField(
						max_length=32,
						required=False,
						widget=forms.TextInput(attrs={'class': 'form-control form-resize mx-auto my-2', 'placeholder': 'Last Name'})
						)
	email 	    = forms.EmailField(
						required=True,
						widget=forms.EmailInput(attrs={'class': 'form-control form-resize mx-auto my-2', 'placeholder': 'Email'})
...
class EditUserPassword(PasswordChangeForm):
	...
	old_password = forms.CharField(
						required=True,
						widget=forms.PasswordInput(attrs={'class': 'form-control form-resize mx-auto my-2', 'placeholder': 'Old Password'})
						)
	new_password1 = forms.CharField(
						required=True,
						widget=forms.PasswordInput(attrs={'class': 'form-control form-resize mx-auto my-2', 'placeholder': 'New Password'})
						)
